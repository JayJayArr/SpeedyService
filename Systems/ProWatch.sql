...
SELECT DESCRP as "Panel Description", LOCATION, FIRMWARE_VERSIONas "Panel Firmware Version", INSTALLED FROM Panel

--SubPanel Firmware Version
SELECT HWDESCRP as "SubPanel Type", DESCRP as "Panel Name", SPANEL.FIRMWARE_VERSION as "Subpanel Firmware Version", SPANEL.INSTALLED FROM SPANEL INNER JOIN Panel on SPANEL.PPID LIKE (PANEL.PPID + '00')
